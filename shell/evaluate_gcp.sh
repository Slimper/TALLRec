#!/bin/bash
echo "Running TALLRec evaluation on GCP - GPU: $1, Output dir: $2"
CUDA_ID=$1
output_dir=$2
...
test_data="/home/$(whoami)/TALLRec/data/movie/test.json"
...
echo "Evaluation complete. Results saved to $2.json"